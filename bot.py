...
app = Flask('')
NAME='@Lakshman_baanbot'  #Add what ever you want to desplay in bot like , i am ____ hostin bot 
@app.route('/')
def home():
...
# --- Configuration ---
TOKEN = '8997015610:AAGCRtKS01JsE4ZOX8M9OU1LH_N4b7IhPWw'
OWNER_ID = 8602611453 # ADD YOUR USER ID 
ADMIN_ID = 8602611453  # DON'T REPLACE IF REPLACE THEN BOT NOT WORKING 
YOUR_USERNAME = '@RAM_RAM_RAM_RAM_RAM_RAM_RAMM' # ADD YOUR USERNAME 
UPDATE_CHANNEL = '@lakshman_baan' # ADD YOUR YOU CHANNEL USERNAME 
